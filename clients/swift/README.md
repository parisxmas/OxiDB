...
curl -LO https://github.com/parisxmas/OxiDB/releases/latest/download/oxidb-embedded-ffi-macos-arm64.tar.gz
...
# iOS device (arm64)
curl -LO https://github.com/parisxmas/OxiDB/releases/latest/download/oxidb-embedded-ffi-ios-arm64.tar.gz
tar xzf oxidb-embedded-ffi-ios-arm64.tar.gz

# iOS simulator (arm64, Apple Silicon Mac)
curl -LO https://github.com/parisxmas/OxiDB/releases/latest/download/oxidb-embedded-ffi-ios-sim-arm64.tar.gz
...
```bash
# macOS arm64 (Apple Silicon)
curl -LO https://github.com/parisxmas/OxiDB/releases/latest/download/oxidb-client-ffi-macos-arm64.tar.gz
...
```swift
dependencies: [
    .package(url: "https://github.com/parisxmas/OxiDB.git", from: "0.25.21")
]
```
