...
export default function Page() {
  ...
  <div class="container">
    <p class="hero-kicker"><span class="hero-pulse"></span>v0.43.0 &middot; a recommendation engine &mdash; &ldquo;also bought&rdquo; in real time &middot; full-text search off the heap &middot; non-blocking index builds &middot; <a href="/license/">source-available</a>, free for production use</p>
...
curl -LO https://oxidb.baltavista.com/releases/v0.43.0/oxidb-server-v0.43.0-darwin-arm64.tar.gz
tar xzf oxidb-server-v0.43.0-darwin-arm64.tar.gz

<span class="co"># Windows: download oxidb-server-v0.43.0-windows-amd64.zip from /downloads/</span></code></pre>
