...
export default function Page() {
  ...
  <div class="container">
    ...
    <div class="release-block">
      ...
      <p class="release-notes"><strong>Realtime and geospatial release.</strong> Change events now carry the document, WebSocket subscription filters speak the full query language, and geo gains polygon geofences, <code>$geoNear</code> and a disk-backed index. <a href="/changelog/">What changed</a>. The document, SQL and time-series engines, the S3 and PostgreSQL wire surfaces, the MQTT and AMQP brokers &mdash; still one binary, source-available and free to run in production at any scale.</p>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.42.12-linux-amd64.tar.gz</code></td>
              <td>10.2 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-server-v0.42.12-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-server-v0.42.12-linux-arm64.tar.gz</code></td>
              <td>9.2 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-server-v0.42.12-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-server-v0.42.12-darwin-arm64.tar.gz</code></td>
              <td>8.9 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-server-v0.42.12-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-server-v0.42.12-darwin-amd64.tar.gz</code></td>
              <td>9.8 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-server-v0.42.12-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.42.12-windows-amd64.zip</code></td>
              <td>9.7 MB</td>
              <td>zip</td>
              <td><a href="/releases/v0.42.12/oxidb-server-v0.42.12-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
              <td>txt</td>
              <td><a href="/releases/v0.42.12/SHA256SUMS.txt" class="dl-btn dl-btn-secondary">Verify</a></td>
            </tr>
          </tbody>
        </table>
      </div>
...
curl -LO https://oxidb.baltavista.com/releases/v0.42.12/oxidb-server-v0.42.12-linux-amd64.tar.gz
tar xzf oxidb-server-v0.42.12-linux-amd64.tar.gz
./oxidb-server
...
cargo add oxidb</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">oxidb CLI v0.42.12</h3>
        <span class="version-date">2026-08-08</span>
        <span class="version-badge latest">latest</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-v0.42.12-linux-amd64.tar.gz</code></td>
              <td>3.7 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-v0.42.12-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-v0.42.12-linux-arm64.tar.gz</code></td>
              <td>3.4 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-v0.42.12-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-v0.42.12-darwin-arm64.tar.gz</code></td>
              <td>3.1 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-v0.42.12-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-v0.42.12-darwin-amd64.tar.gz</code></td>
              <td>3.4 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-v0.42.12-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-v0.42.12-windows-amd64.zip</code></td>
              <td>3.6 MB</td>
              <td>zip</td>
              <td><a href="/releases/v0.42.12/oxidb-v0.42.12-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
      ...
      <div class="install-hint">
        ...
        <pre><code><span class="co"># Linux / macOS</span>
curl -LO https://oxidb.baltavista.com/releases/v0.42.12/oxidb-v0.42.12-linux-amd64.tar.gz
tar xzf oxidb-v0.42.12-linux-amd64.tar.gz
...
cargo build --release -p oxidb-cli</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">oxidb-mcp v0.42.12</h3>
        <span class="version-date">2026-08-08</span>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-mcp-v0.42.12-linux-amd64.tar.gz</code></td>
              <td>500 KB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-mcp-v0.42.12-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-mcp-v0.42.12-linux-arm64.tar.gz</code></td>
              <td>456 KB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.42.12/oxidb-mcp-v0.42.12-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-mcp-v0.42.12-darwin-arm64.tar.gz</code></td>
              <td>386 KB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-mcp-v0.42.12-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-mcp-v0.42.12-darwin-amd64.tar.gz</code></td>
              <td>424 KB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.42.12/oxidb-mcp-v0.42.12-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-mcp-v0.42.12-windows-amd64.zip</code></td>
              <td>416 KB</td>
              <td>zip</td>
              <td><a href="/releases/v0.42.12/oxidb-mcp-v0.42.12-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
      ...
      <div class="install-hint">
        ...
        <pre><code><span class="co"># Linux / macOS</span>
curl -LO https://oxidb.baltavista.com/releases/v0.42.12/oxidb-mcp-v0.42.12-linux-amd64.tar.gz
tar xzf oxidb-mcp-v0.42.12-linux-amd64.tar.gz
...
<span class="co"># enforced by the server. Writes additionally need OXIDB_MCP_WRITES=1.</span></code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">OxiDB Studio v0.3.0</h3>
        <span class="version-date">2026-07-19</span>
        <span class="version-badge latest">latest</span>
      </div>
      <p class="release-notes">Desktop GUI (Tauri) — SQL editor with schema tree, a visual Query Designer (drag-to-connect joins), editable result grids, table CRUD, SCRAM auth with saved connections, and an OxiMem browser.</p>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>OxiDB-Studio-0.3.0-macos-arm64.dmg</code></td>
              <td>6.1 MB</td>
              <td>dmg</td>
              <td><a href="/releases/studio/OxiDB-Studio-0.3.0-macos-arm64.dmg" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>Windows &amp; Linux builds</strong> — coming soon (built per-platform)</td>
              <td></td>
              <td></td>
              <td><a href="https://github.com/parisxmas/OxiDB" class="dl-btn dl-btn-secondary">Source</a></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="install-hint">
        <h4>Install (macOS)</h4>
        <pre><code><span class="co"># Download, open the .dmg, drag OxiDB to Applications.</span>
<span class="co"># First launch: right-click → Open (unsigned build).</span>
curl -LO https://oxidb.baltavista.com/releases/studio/OxiDB-Studio-0.3.0-macos-arm64.dmg</code></pre>
      </div>
    </div>

    <!-- .NET / EF Core NuGet v0.42.12 -->
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">.NET / EF Core v0.42.12</h3>
        <span class="version-date">2026-08-08</span>
        <span class="version-badge latest">latest</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              ...
              <td>22 KB</td>
              <td><a href="/nuget/OxiDb.EntityFrameworkCore.0.42.12.nupkg" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              ...
              <td><code>.nupkg</code></td>
              <td>19 KB</td>
              <td><a href="/nuget/OxiDb.Data.0.42.12.nupkg" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              ...
              <td><code>.nupkg</code></td>
              <td>43 KB</td>
              <td><a href="/nuget/OxiDb.Client.Tcp.0.42.12.nupkg" class="dl-btn">Download</a></td>
            </tr>
          </tbody>
        </table>
      </div>
...
curl -LO https://oxidb.baltavista.com/nuget/OxiDb.EntityFrameworkCore.0.42.12.nupkg
curl -LO https://oxidb.baltavista.com/nuget/OxiDb.Data.0.42.12.nupkg
curl -LO https://oxidb.baltavista.com/nuget/OxiDb.Client.Tcp.0.42.12.nupkg
...
dotnet add package OxiDb.EntityFrameworkCore</code></pre>
    ...
    <!-- WebAssembly v0.42.12 -->
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">WebAssembly v0.42.12</h3>
        <span class="version-date">2026-08-08</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Browser</td>
              <td>wasm32</td>
              <td><code>oxidb-wasm-v0.42.12.tar.gz</code></td>
              <td>876 KB</td>
              <td>wasm-pack</td>
              <td><a href="/releases/v0.42.12/oxidb-wasm-v0.42.12.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
  ...
  /releases/v0.42.12/oxidb-wasm-v0.42.12.tar.gz
