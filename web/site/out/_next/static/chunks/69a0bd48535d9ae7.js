(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,14287,a=>{"use strict";var s=a.i(43476),n=a.i(71645);function t(){return(0,n.useEffect)(()=>{document.querySelectorAll(".lang-tab").forEach(a=>{a.addEventListener("click",()=>{let s=a.closest(".doc-block");if(!s)return;s.querySelectorAll(".lang-tab").forEach(a=>a.classList.remove("active")),s.querySelectorAll(".lang-panel").forEach(a=>a.classList.remove("active")),a.classList.add("active");let n=a.getAttribute("data-lang");s.querySelectorAll(`.lang-panel[data-lang="${n}"]`).forEach(a=>a.classList.add("active"))})}),document.querySelectorAll(".lang-tab").forEach(a=>{a.addEventListener("dblclick",()=>{let s=a.getAttribute("data-lang");document.querySelectorAll(".doc-block").forEach(a=>{let n=a.querySelector(`.lang-tab[data-lang="${s}"]`);n&&(a.querySelectorAll(".lang-tab").forEach(a=>a.classList.remove("active")),a.querySelectorAll(".lang-panel").forEach(a=>a.classList.remove("active")),n.classList.add("active"),a.querySelectorAll(`.lang-panel[data-lang="${s}"]`).forEach(a=>a.classList.add("active")))})})})},[]),(0,s.jsx)("div",{dangerouslySetInnerHTML:{__html:`<section class="section">
  <div class="container">
