...
echo -e "${BOLD}╔══════════════════════════════════════════════════════════════╗${RESET}"
echo -e "${BOLD}║   OxiDB vs PostgreSQL — Docker Comparison Test Suite        ║${RESET}"
echo -e "${BOLD}╚══════════════════════════════════════════════════════════════╝${RESET}"
echo ""
...
# ── Step 3: Run tests ────────────────────────────────────────────────
echo -e "${CYAN}[3/4] Running comparison tests...${RESET}"
echo ""
set +e
...
echo -e "${CYAN}[4/4] Running benchmarks...${RESET}"
echo ""
set +e
