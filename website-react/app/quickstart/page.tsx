...
export default function Page() {
  ...
  <div class="container">
    ...
    <h4>Linux (x86_64)</h4>
    <pre><code class="lang-bash">curl -LO https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/oxidb-server-v0.25.3-linux-amd64.tar.gz
tar xzf oxidb-server-v0.25.3-linux-amd64.tar.gz
sudo mv oxidb-server /usr/local/bin/
oxidb-server --version</code></pre>

    <h4>Linux (ARM64)</h4>
    <pre><code class="lang-bash">curl -LO https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/oxidb-server-v0.25.3-linux-arm64.tar.gz
tar xzf oxidb-server-v0.25.3-linux-arm64.tar.gz
...
curl -LO https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/oxidb-server-v0.25.3-darwin-amd64.tar.gz
tar xzf oxidb-server-v0.25.3-darwin-amd64.tar.gz

sudo mv oxidb-server /usr/local/bin/</code></pre>

    <h4>Windows (x86_64)</h4>
    <pre><code class="lang-bash"><span class="co"># PowerShell</span>
Invoke-WebRequest -Uri https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/oxidb-server-v0.25.3-windows-amd64.zip -OutFile oxidb-server.zip
...
./target/release/oxidb-server --version</code></pre>
  ...
  ghcr.io/parisxmas/oxidb:0.25.3</code></pre>
...
db.insert(<span class="str">"users"</span>, {<span class="str">"name"</span>: <span class="str">"Alice"</span>, <span class="str">"age"</span>: <span class="num">30</span>})</code></pre>
    ...
    <h3>Production: 3-node Raft cluster <span class="version-badge latest">v0.25.3</span></h3>
