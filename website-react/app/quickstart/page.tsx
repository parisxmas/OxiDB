...
export default function Page() {
  ...
  <div class="container">
    ...
    <h4>Linux (x86_64)</h4>
    <pre><code class="lang-bash">curl -LO https://github.com/parisxmas/OxiDB/releases/download/v0.28.18/oxidb-server-v0.28.18-linux-amd64.tar.gz
tar xzf oxidb-server-v0.28.18-linux-amd64.tar.gz
sudo mv oxidb-server /usr/local/bin/
oxidb-server --version</code></pre>

    <h4>Linux (ARM64)</h4>
    <pre><code class="lang-bash">curl -LO https://github.com/parisxmas/OxiDB/releases/download/v0.28.18/oxidb-server-v0.28.18-linux-arm64.tar.gz
...
./target/release/oxidb-server --version</code></pre>
  ...
  ghcr.io/parisxmas/oxidb:0.28.18</code></pre>
...
db.insert(<span class="str">"users"</span>, {<span class="str">"name"</span>: <span class="str">"Alice"</span>, <span class="str">"age"</span>: <span class="num">30</span>})</code></pre>
    ...
    <h3>Production: 3-node Raft cluster <span class="version-badge latest">v0.28.18</span></h3>
