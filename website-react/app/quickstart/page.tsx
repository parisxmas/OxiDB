...
export default function Page() {
  ...
  <div class="container">
    ...
    <h4>Linux (x86_64)</h4>
    <pre><code class="lang-bash">curl -LO https://oxidb.baltavista.com/releases/v0.39.15/oxidb-server-v0.39.15-linux-amd64.tar.gz
tar xzf oxidb-server-v0.39.15-linux-amd64.tar.gz
sudo mv oxidb-server /usr/local/bin/
oxidb-server --version</code></pre>

    <h4>Linux (ARM64)</h4>
    <pre><code class="lang-bash">curl -LO https://oxidb.baltavista.com/releases/v0.39.15/oxidb-server-v0.39.15-linux-arm64.tar.gz
tar xzf oxidb-server-v0.39.15-linux-arm64.tar.gz
...
curl -LO https://oxidb.baltavista.com/releases/v0.39.15/oxidb-server-v0.39.15-darwin-amd64.tar.gz
tar xzf oxidb-server-v0.39.15-darwin-amd64.tar.gz

sudo mv oxidb-server /usr/local/bin/</code></pre>

    <h4>Windows (x86_64)</h4>
    <pre><code class="lang-bash"><span class="co"># PowerShell</span>
Invoke-WebRequest -Uri https://oxidb.baltavista.com/releases/v0.39.15/oxidb-server-v0.39.15-windows-amd64.zip -OutFile oxidb-server.zip
...
db.insert(<span class="str">"users"</span>, {<span class="str">"name"</span>: <span class="str">"Alice"</span>, <span class="str">"age"</span>: <span class="num">30</span>})</code></pre>
    ...
    <h3>Production: 3-node Raft cluster <span class="version-badge latest">v0.39.15</span></h3>
