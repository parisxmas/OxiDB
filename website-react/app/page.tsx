...
export default function Page() {
  ...
  <div class="container">
    <p class="hero-kicker"><span class="hero-pulse"></span>v0.42 &middot; speaks the PostgreSQL wire protocol &mdash; psql, JDBC, Npgsql, DBeaver connect unmodified &middot; embedded EF Core &middot; <a href="/license/">source-available</a>, free for your own production use</p>
...
<span class="co"># Windows: download oxidb-server-v0.42.0-windows-amd64.zip from /downloads/</span></code></pre>
