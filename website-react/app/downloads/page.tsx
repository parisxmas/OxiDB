...
curl -LO https://oxidb.baltavista.com/releases/v0.25.3/oxidb-server-v0.25.3-linux-amd64.tar.gz
...
cargo add oxidb</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">oxidb CLI v0.25.3</h3>
        <span class="version-date">2026-04-10</span>
        <span class="version-badge latest">latest</span>
      </div>
      ...
      <div class="install-hint">
        ...
        <pre><code><span class="co"># Linux / macOS</span>
curl -LO https://oxidb.baltavista.com/releases/v0.25.3/oxidb-cli-v0.25.3-linux-amd64.tar.gz
...
cargo build --release -p oxidb-cli</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">WebAssembly v0.25.3</h3>
        <span class="version-date">2026-04-10</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Browser</td>
              <td>wasm32</td>
              <td><code>oxidb-wasm-v0.25.3.tar.gz</code></td>
              <td>1.5 MB</td>
              <td>wasm-pack</td>
              <td><a href="https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/oxidb-wasm-v0.25.3.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
              <td>txt</td>
              <td><a href="https://github.com/parisxmas/OxiDB/releases/download/v0.25.3/SHA256SUMS.txt" class="dl-btn dl-btn-secondary">Verify</a></td>
            </tr>
          </tbody>
        </table>
      </div>
