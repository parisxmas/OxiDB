        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.24.0-linux-amd64.tar.gz</code></td>
              <td>5.4 MB</td>
              <td>musl static</td>
              <td><a href="releases/v0.24.0/oxidb-server-v0.24.0-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-server-v0.24.0-linux-arm64.tar.gz</code></td>
              <td>4.8 MB</td>
              <td>musl static</td>
              <td><a href="releases/v0.24.0/oxidb-server-v0.24.0-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-server-v0.24.0-darwin-arm64.tar.gz</code></td>
              <td>4.6 MB</td>
              <td>tar.gz</td>
              <td><a href="releases/v0.24.0/oxidb-server-v0.24.0-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-server-v0.24.0-darwin-amd64.tar.gz</code></td>
              <td>5.1 MB</td>
              <td>tar.gz</td>
              <td><a href="releases/v0.24.0/oxidb-server-v0.24.0-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.24.0-windows-amd64.zip</code></td>
              <td>5.0 MB</td>
              <td>zip</td>
              <td><a href="releases/v0.24.0/oxidb-server-v0.24.0-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
              <td>txt</td>
              <td><a href="releases/v0.24.0/SHA256SUMS.txt" class="dl-btn dl-btn-secondary">Verify</a></td>
            </tr>
          </tbody>
        </table>
      </div>
...
curl -LO https://oxidb.baltavista.com/releases/v0.24.0/oxidb-server-v0.24.0-linux-amd64.tar.gz
tar xzf oxidb-server-v0.24.0-linux-amd64.tar.gz
./oxidb-server
...
cargo add oxidb</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">oxidb CLI v0.24.0</h3>
        <span class="version-date">2026-04-10</span>
        <span class="version-badge latest">latest</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-cli-v0.24.0-linux-amd64.tar.gz</code></td>
              <td>3.9 MB</td>
              <td>musl static</td>
              <td><a href="releases/v0.24.0/oxidb-cli-v0.24.0-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-cli-v0.24.0-linux-arm64.tar.gz</code></td>
              <td>3.6 MB</td>
              <td>musl static</td>
              <td><a href="releases/v0.24.0/oxidb-cli-v0.24.0-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-cli-v0.24.0-darwin-arm64.tar.gz</code></td>
              <td>3.3 MB</td>
              <td>tar.gz</td>
              <td><a href="releases/v0.24.0/oxidb-cli-v0.24.0-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-cli-v0.24.0-darwin-amd64.tar.gz</code></td>
              <td>3.7 MB</td>
              <td>tar.gz</td>
              <td><a href="releases/v0.24.0/oxidb-cli-v0.24.0-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-cli-v0.24.0-windows-amd64.zip</code></td>
              <td>3.8 MB</td>
              <td>zip</td>
              <td><a href="releases/v0.24.0/oxidb-cli-v0.24.0-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
      ...
      <div class="install-hint">
        ...
        <pre><code><span class="co"># Linux / macOS</span>
curl -LO https://oxidb.baltavista.com/releases/v0.24.0/oxidb-cli-v0.24.0-linux-amd64.tar.gz
tar xzf oxidb-cli-v0.24.0-linux-amd64.tar.gz
...
cargo build --release -p oxidb-cli</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">WebAssembly v0.24.0</h3>
        <span class="version-date">2026-04-10</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Browser</td>
              <td>wasm32</td>
              <td><code>oxidb-wasm-v0.24.0.tar.gz</code></td>
              <td>1.5 MB</td>
              <td>wasm-pack</td>
              <td><a href="https://github.com/parisxmas/OxiDB/releases/download/v0.24.0/oxidb-wasm-v0.24.0.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
              <td>txt</td>
              <td><a href="https://github.com/parisxmas/OxiDB/releases/download/v0.24.0/SHA256SUMS.txt" class="dl-btn dl-btn-secondary">Verify</a></td>
            </tr>
          </tbody>
        </table>
      </div>
