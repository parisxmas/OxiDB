...
export default function Page() {
  ...
  <div class="container">
    ...
    <div class="release-block">
      ...
      <p class="release-notes"><strong>AMQP &mdash; the RabbitMQ protocol</strong>: work queues with competing consumers, direct/fanout/topic exchanges, publisher confirms, durable queues that survive SIGKILL, an MQTT bridge via <code>amq.topic</code> &mdash; and faster than RabbitMQ on 5 of 6 benchmark scenarios. Plus online WAL checkpointing, typed .NET TSDB API, and real MD5 S3 ETags. <a href="/changelog/">Full changelog</a></p>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.37.0-linux-amd64.tar.gz</code></td>
              <td>9.8 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.37.0/oxidb-server-v0.37.0-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-server-v0.37.0-linux-arm64.tar.gz</code></td>
              <td>8.8 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.37.0/oxidb-server-v0.37.0-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-server-v0.37.0-darwin-arm64.tar.gz</code></td>
              <td>8.5 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.37.0/oxidb-server-v0.37.0-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-server-v0.37.0-darwin-amd64.tar.gz</code></td>
              <td>9.4 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.37.0/oxidb-server-v0.37.0-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-server-v0.37.0-windows-amd64.zip</code></td>
              <td>9.3 MB</td>
              <td>zip</td>
              <td><a href="/releases/v0.37.0/oxidb-server-v0.37.0-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
              <td>txt</td>
              <td><a href="/releases/v0.37.0/SHA256SUMS.txt" class="dl-btn dl-btn-secondary">Verify</a></td>
            </tr>
          </tbody>
        </table>
      </div>
...
curl -LO https://oxidb.baltavista.com/releases/v0.37.0/oxidb-server-v0.37.0-linux-amd64.tar.gz
tar xzf oxidb-server-v0.37.0-linux-amd64.tar.gz
./oxidb-server
...
cargo add oxidb</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">oxidb CLI v0.37.0</h3>
        <span class="version-date">2026-07-17</span>
        <span class="version-badge latest">latest</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Linux</td>
              <td>x86_64</td>
              <td><code>oxidb-v0.37.0-linux-amd64.tar.gz</code></td>
              <td>3.6 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.37.0/oxidb-v0.37.0-linux-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Linux</td>
              <td>ARM64</td>
              <td><code>oxidb-v0.37.0-linux-arm64.tar.gz</code></td>
              <td>3.3 MB</td>
              <td>musl static</td>
              <td><a href="/releases/v0.37.0/oxidb-v0.37.0-linux-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>ARM64 (Apple Silicon)</td>
              <td><code>oxidb-v0.37.0-darwin-arm64.tar.gz</code></td>
              <td>3.1 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.37.0/oxidb-v0.37.0-darwin-arm64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>macOS</td>
              <td>x86_64 (Intel)</td>
              <td><code>oxidb-v0.37.0-darwin-amd64.tar.gz</code></td>
              <td>3.4 MB</td>
              <td>tar.gz</td>
              <td><a href="/releases/v0.37.0/oxidb-v0.37.0-darwin-amd64.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              <td>Windows</td>
              <td>x86_64</td>
              <td><code>oxidb-v0.37.0-windows-amd64.zip</code></td>
              <td>3.5 MB</td>
              <td>zip</td>
              <td><a href="/releases/v0.37.0/oxidb-v0.37.0-windows-amd64.zip" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
      ...
      <div class="install-hint">
        ...
        <pre><code><span class="co"># Linux / macOS</span>
curl -LO https://oxidb.baltavista.com/releases/v0.37.0/oxidb-v0.37.0-linux-amd64.tar.gz
tar xzf oxidb-v0.37.0-linux-amd64.tar.gz
...
curl -LO https://oxidb.baltavista.com/releases/studio/OxiDB-Studio-0.3.0-macos-arm64.dmg</code></pre>
    ...
    <!-- .NET / EF Core NuGet v0.37.0 -->
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">.NET / EF Core v0.37.0</h3>
        <span class="version-date">2026-07-17</span>
        <span class="version-badge latest">latest</span>
      </div>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              ...
              <td>23 KB</td>
              <td><a href="/nuget/OxiDb.EntityFrameworkCore.0.36.0.nupkg" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              ...
              <td><code>.nupkg</code></td>
              <td>18 KB</td>
              <td><a href="/nuget/OxiDb.Data.0.36.0.nupkg" class="dl-btn">Download</a></td>
            </tr>
            <tr>
              ...
              <td><code>.nupkg</code></td>
              <td>31 KB</td>
              <td><a href="/nuget/OxiDb.Client.Tcp.0.36.0.nupkg" class="dl-btn">Download</a></td>
            </tr>
          </tbody>
        </table>
      </div>
...
dotnet add package OxiDb.EntityFrameworkCore</code></pre>
    ...
    <div class="release-block">
      <div class="release-header">
        <h3 class="version-tag">WebAssembly v0.37.0</h3>
        ...
        <table class="dl-table">
          ...
          <tbody>
            <tr>
              <td>Browser</td>
              <td>wasm32</td>
              <td><code>oxidb-wasm-v0.37.0.tar.gz</code></td>
              <td>0.8 MB</td>
              <td>wasm-pack</td>
              <td><a href="/releases/v0.37.0/oxidb-wasm-v0.37.0.tar.gz" class="dl-btn">Download</a></td>
            </tr>
            <tr class="checksum-row">
              <td colspan="3"><strong>SHA256 Checksums</strong></td>
              <td></td>
  ...
  /releases/v0.37.0/oxidb-wasm-v0.37.0.tar.gz
