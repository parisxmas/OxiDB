...
dotnet add package OxiDb.Data</code></pre>
      <p>Latest: <strong>v0.40.0</strong>. The EF Core packages are hosted on this site &mdash; add it as a NuGet source, or download the <code>.nupkg</code> files directly:</p>
