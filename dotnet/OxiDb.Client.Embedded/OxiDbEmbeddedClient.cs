...
public sealed class OxiDbEmbeddedClient : IOxiDbClient
{
    ...
    /// <summary>
    /// Executes SQL against the embedded standalone SQL engine. Its data
    /// lives under <c>&lt;data dir&gt;/sql</c>, entirely separate from
    /// document collections; the engine opens lazily on the first call.
    /// Same result shapes as the TCP client.
    /// </summary>
