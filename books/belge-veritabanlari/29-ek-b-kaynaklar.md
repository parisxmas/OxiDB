...
2. Bloom, B. H. "Space/Time Trade-offs in Hash Coding with Allowable Errors."
   *Communications of the ACM*, 13(7), 1970, ss. 422–426.
...
4. Bayer, R. ve McCreight, E. M. "Organization and Maintenance of Large Ordered
   Indexes." *Acta Informatica*, 1(3), 1972, ss. 173–189.
   <https://doi.org/10.1007/BF00288683>

5. Codd, E. F. "Further Normalization of the Data Base Relational Model."
   R. Rustin (ed.), *Data Base Systems* (Courant Computer Science Symposia 6),
   Prentice-Hall, 1972, ss. 33–64.

6. Bachman, C. W. "The Programmer as Navigator." *Communications of the ACM*,
   16(11), 1973, ss. 653–658. <https://doi.org/10.1145/355611.362534>
...
8. Gifford, D. K. "Weighted Voting for Replicated Data." *Proc. ACM SOSP*, 1979,
   ss. 150–162. <https://doi.org/10.1145/800215.806583>

9. Selinger, P. G.; Astrahan, M. M.; Chamberlin, D. D.; Lorie, R. A.;
...
10. Gray, J. "The Transaction Concept: Virtues and Limitations." *Proc. 7th Int.
...
12. Bernstein, P. A. ve Goodman, N. "Multiversion Concurrency Control—Theory and
    Algorithms." *ACM Transactions on Database Systems*, 8(4), 1983, ss. 465–483.
    <https://doi.org/10.1145/319996.319998>

13. Fischer, M. J.; Lynch, N. A.; Paterson, M. S. "Impossibility of Distributed
    Consensus with One Faulty Process." *Journal of the ACM*, 32(2), 1985,
    ss. 374–382. <https://doi.org/10.1145/3149.214121>

14. Herlihy, M. P. ve Wing, J. M. "Linearizability: A Correctness Condition for
    Concurrent Objects." *ACM Transactions on Programming Languages and Systems*,
    12(3), 1990, ss. 463–492. <https://doi.org/10.1145/78969.78972>
...
16. Gray, J. ve Reuter, A. *Transaction Processing: Concepts and Techniques.*
    Morgan Kaufmann, 1992. ISBN 978-1-55860-190-1.
...
18. Graefe, G. "Volcano—An Extensible and Parallel Query Evaluation System."
    *IEEE Transactions on Knowledge and Data Engineering*, 6(1), 1994,
    ss. 120–135. <https://doi.org/10.1109/69.273032>

19. Berenson, H.; Bernstein, P.; Gray, J.; Melton, J.; O'Neil, E.; O'Neil, P. "A
    Critique of ANSI SQL Isolation Levels." *Proc. ACM SIGMOD*, 1995, ss. 1–10.
    <https://doi.org/10.1145/223784.223785>

20. O'Neil, P.; Cheng, E.; Gawlick, D.; O'Neil, E. "The Log-Structured Merge-Tree
    (LSM-Tree)." *Acta Informatica*, 33(4), 1996, ss. 351–385.
    <https://doi.org/10.1007/s002360050048>

21. Karger, D.; Lehman, E.; Leighton, T.; Panigrahy, R.; Levine, M.; Lewin, D.
    "Consistent Hashing and Random Trees: Distributed Caching Protocols for
    Relieving Hot Spots on the World Wide Web." *Proc. ACM STOC*, 1997,
    ss. 654–663. <https://doi.org/10.1145/258533.258660>

22. Lamport, L. "The Part-Time Parliament." *ACM Transactions on Computer
    Systems*, 16(2), 1998, ss. 133–169. <https://doi.org/10.1145/279227.279229>

23. Adya, A.; Liskov, B.; O'Neil, P. "Generalized Isolation Level Definitions."
    *Proc. IEEE ICDE*, 2000, ss. 67–78.
...
26. Megiddo, N. ve Modha, D. S. "ARC: A Self-Tuning, Low Overhead Replacement
    Cache." *Proc. USENIX FAST*, 2003.
...
27. DeCandia, G.; Hastorun, D.; Jampani, M.; Kakulapati, G.; Lakshman, A.;
    ...
    Highly Available Key-value Store." *Proc. ACM SOSP*, 2007, ss. 205–220.
    <https://doi.org/10.1145/1294261.1294281>

28. Cahill, M. J.; Röhm, U.; Fekete, A. D. "Serializable Isolation for Snapshot
    Databases." *Proc. ACM SIGMOD*, 2008, ss. 729–738.
...
30. Percival, C. "Stronger Key Derivation via Sequential Memory-Hard Functions."
    *BSDCan*, 2009. <https://www.tarsnap.com/scrypt/scrypt.pdf>

31. Robertson, S. ve Zaragoza, H. "The Probabilistic Relevance Framework: BM25
...
33. Abadi, D. J. "Consistency Tradeoffs in Modern Distributed Database System
...
36. Biryukov, A.; Dinu, D.; Khovratovich, D. "Argon2: New Generation of
    Memory-Hard Functions for Password Hashing and Other Applications." *Proc.
    IEEE EuroS&P*, 2016, ss. 292–302. <https://doi.org/10.1109/EuroSP.2016.31>

37. Lu, L.; Pillai, T. S.; Arpaci-Dusseau, A. C.; Arpaci-Dusseau, R. H.
...
38. Bray, T. (ed.). *RFC 8259: The JavaScript Object Notation (JSON) Data
    Interchange Format.* IETF, STD 90, 2017.
    <https://www.rfc-editor.org/rfc/rfc8259.html>

39. Ecma International. *ECMA-404: The JSON Data Interchange Syntax.* 2. baskı,
    2017.
    <https://ecma-international.org/publications-and-standards/standards/ecma-404/>

40. Kleppmann, M. *Designing Data-Intensive Applications.* O'Reilly Media, 2017.
    <https://dataintensive.net/>

41. Petrov, A. *Database Internals: A Deep Dive into How Distributed Data Systems
    Work.* O'Reilly Media, 2019. <https://www.databass.dev/>

42. Bormann, C. ve Hoffman, P. *RFC 8949: Concise Binary Object Representation
    (CBOR).* IETF, 2020. <https://doi.org/10.17487/RFC8949>

43. Collet, Y. ve Kucherawy, M. (ed.). *RFC 8878: Zstandard Compression and the
    'application/zstd' Media Type.* IETF, 2021.
    <https://doi.org/10.17487/RFC8878>

Aşağıdaki kaynaklar, sürümsüz/canlı çevrimiçi belgelerdir:

44. Crockford, D. "Introducing JSON." json.org. <https://www.json.org/>

45. *BSON (Binary JSON) Specification.* MongoDB Inc.
    <https://bsonspec.org/spec.html>

46. *JSON Schema — Specification.* JSON Schema Org.
